...
Only requiring some minor changes is cmk.cpp.
...
Changes to cmk.cpp
----------------------
cmk.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
