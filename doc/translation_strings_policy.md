...
This document provides guidelines for internationalization of the cmk Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to cmk network</source>
        <translation>
            <numerusform>%n active connection to cmk network</numerusform>
            <numerusform>%n active connections to cmk network</numerusform>
        </translation>
    </message>
