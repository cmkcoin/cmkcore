...
Every pull request to the cmk Core repository is built and run through
...
```
  ...
  --srcdir=SRCDIR       Source directory containing cmkd/cmk-cli
                        (default: ../../src)
...
blocks (25*500=12500 CMK) in its wallet.
