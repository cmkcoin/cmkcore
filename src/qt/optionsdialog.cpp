    ...
    mapper(0)
{
    ...
    /* Theme selector 
    /*ui->theme->addItem(QString("cmk-light"), QVariant("light"));
    ui->theme->addItem(QString("cmk-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("cmk-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("cmk-traditional"), QVariant("trad"));*/
