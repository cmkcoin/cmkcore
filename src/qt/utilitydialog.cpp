    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("cmk Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About cmk Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  cmk-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the cmk in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CMK, 0.1 CMK, 1 CMK and 10 CMK -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("cmk Core is shutting down...") + "<br /><br />" +
