...
// Copyright (c) 2014-2017 The cmk Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("cmk Core - Genesis") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CMK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CMK: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About cmk Core"), this);
    aboutAction->setStatusTip(tr("Show information about cmk Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for cmk Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your cmk addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified cmk addresses"));
    ...
    openAction->setStatusTip(tr("Open a cmk: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the cmk Core help message to get a list with possible cmk Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("cmk Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to cmk network", "", count));
}
...
{
    QString strTitle = tr("cmk Core"); // default title
