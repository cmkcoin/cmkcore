...
{
    const char* pszTimestamp = "Start Wired CMKCoind core Is Now payment anywhere";
    const CScript genesisOutputScript = CScript() << ParseHex("045d16235dbfafd80e6ae1221aaf3dfa34472d0251b602f5297ee09094758f01f1c7da917b069e159212baf5dde39d134e2db16d22a4481ce3714985457f01e90e") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("0458940eaa3bee856f532cf0eac036e71bbc3b5934759e0386e820c93eece6738d46c0b8e4a7c36f8df7920e78d950c8a7ff00e313d2c84b08133e45f1c778259d");
        nDefaultPort = 1769;
        ...
        genesis = CreateGenesisBlock(1524729000, 1283324, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000508d086b887c4cb720d9f87551bcb1add66240572454fa5f01e34f4ba4"));
        assert(genesis.hashMerkleRoot == uint256S("0x876f7ff1682bf8c03eacb0019a13a822670db8c83cfdcbc7042deeafe5193927"));


        vSeeds.push_back(CDNSSeedData("dnsseed.marketc.net", "dnsseed.marketc.net"));
		vSeeds.push_back(CDNSSeedData("dnsseed.marketc.io", "dnsseed.marketc.io"));

        // Cmk addresses start with K or L
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,47);
        // Cmk script addresses start with 'J'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,43);
        // Cmk private keys start with 'y' or 'z'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,141);

        // Cmk  BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Cmk  BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Cmk  BIP44 coin type is '5'
        ...
        strSporkPubKey = "04435be392725ff15aebe3a9b4cfe55ff8f21c4e9064cb03a777497d25cc9d578fc690a31c977569cb45b9632225998393f78e7e3670d8d786476d6d5882e8dcf1";
        strMasternodePaymentsPubKey = "04f0ff89c78261c2837c06b75112610965c9c8f814383ab28cf25c425b823ee5f888ec5278ee7cd77849ec01cbf649e112087bc5cf583626d786363e48616df590";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x000000508d086b887c4cb720d9f87551bcb1add66240572454fa5f01e34f4ba4"))
			,
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("04f0ff89c78261c2837c06b75112610965c9c8f814383ab28cf25c425b823ee5f888ec5278ee7cd77849ec01cbf649e112087bc5cf583626d786363e48616df590");
        nDefaultPort = 34157;
